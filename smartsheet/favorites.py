...
class Favorites:
    ...
    def remove_favorites(self, favorite_type: FavoriteType, object_ids) -> Union[Result[None], Error]:
        ...
        _op["method"] = "DELETE"
        _op["path"] = "/favorites/" + favorite_type.name.lower()
    ...
    def is_favorite(self, favorite_type: FavoriteType, favorite_id, include=None) -> Union[Favorite, Error]:
        ...
        _op["method"] = "GET"
        _op["path"] = "/favorites/" + favorite_type.name.lower() + "/" + str(favorite_id)
